    ...
    <>
      ...
      <style>{`
        ...
        .morph-loader svg path:first-child {
          will-change: d;
          fill: var(--main-color);
          animation: morph var(--duration) ease-in-out infinite;
        }
        ...
        @keyframes morph {
          ...
          66% {
            d: path("M10,50 C10,38.95 14.48,28.95 21.72,21.72 L21.72,21.72 C28.95,14.48 38.95,10 50,10 L50,10 C61.05,10 71.05,14.48 78.28,21.72 L78.28,21.72 C85.52,28.95 90,38.95 90,50 L90,50 C90,61.05 85.52,71.05 78.28,78.28 L78.28,78.28 C71.05,85.52 61.05,90 50,90 L50,90 C38.95,90 28.95,85.52 21.72,78.28 L21.72,78.28 C14.48,71.05 10,61.05 10,50Z");
          }
        }
      `}</style>
    </>
